...
class HairDye():
    def __init__(self):
        ...
        self.model_path = os.path.join(os.path.dirname(__file__), 'models', '79999_iter.pth')
        self.anno = None
    ...
    def get_parsing(self, img, save_path="/content"):
        ...
        net.load_state_dict(torch.load(self.model_path, map_location=torch.device('cpu')))
